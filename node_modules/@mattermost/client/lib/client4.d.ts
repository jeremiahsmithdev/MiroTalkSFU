...
export default class Client4 {
    ...
    getRemoteClustersRoute(): string;
    getRemoteClusterRoute(remoteId: string): string;
    getCustomProfileAttributeFieldsRoute(): string;
    getCustomProfileAttributeFieldRoute(propertyFieldId: string): string;
    getCustomProfileAttributeValuesRoute(): string;
    ...
    patchUser: (userPatch: PartialExcept<UserProfile, "id">) => Promise<UserProfile>;
    ...
    resetFailedAttempts: (userId: string) => Promise<StatusOK>;
    ...
    startUsersBatchExport: (filter: UserReportFilter) => Promise<StatusOK>;
    /**
     * @deprecated
     */
    ...
    patchTeam: (team: PartialExcept<Team, "id">) => Promise<Team>;
    ...
    createChannel: (channel: PartialExcept<Channel, "name" | "display_name" | "type" | "team_id">) => Promise<ServerChannel>;
    ...
    searchAllChannels(term: string, opts: {
        page: number;
        per_page: number;
    } & ChannelSearchOpts & OptsSignalExt): Promise<ChannelsWithTotalCount>;
    ...
    getRemoteCluster: (remoteId: string) => Promise<RemoteCluster>;
    createRemoteCluster: (remoteCluster: PartialExcept<RemoteClusterWithPassword, "name" | "display_name">) => Promise<{
        invite: string;
        password: string;
        remote_cluster: RemoteCluster;
    }>;
    patchRemoteCluster: (remoteId: string, patch: Partial<RemoteClusterPatch>) => Promise<RemoteCluster>;
    deleteRemoteCluster: (remoteId: string) => Promise<unknown>;
    acceptInviteRemoteCluster: (remoteClusterAcceptInvite: RemoteClusterAcceptInvite) => Promise<RemoteCluster>;
    generateInviteRemoteCluster: (remoteId: string, remoteCluster: Partial<Pick<RemoteClusterWithPassword, "password">>) => Promise<string>;
    getSharedChannelRemotes: (remoteId: string, filters: {
        exclude_remote?: boolean;
        exclude_home?: boolean;
        include_deleted?: boolean;
        include_unconfirmed?: boolean;
        exclude_confirmed?: boolean;
    }) => Promise<SharedChannelRemote[]>;
    sharedChannelRemoteInvite: (remoteId: string, channelId: string) => Promise<StatusOK>;
    sharedChannelRemoteUninvite: (remoteId: string, channelId: string) => Promise<StatusOK>;
    getCustomProfileAttributeFields: () => Promise<UserPropertyField[]>;
    createCustomProfileAttributeField: (patch: UserPropertyFieldPatch) => Promise<UserPropertyField>;
    patchCustomProfileAttributeField: (fieldId: string, patch: UserPropertyFieldPatch) => Promise<UserPropertyField>;
    deleteCustomProfileAttributeField: (fieldId: string) => Promise<StatusOK>;
    updateCustomProfileAttributeValues: (attributeValues: Record<string, string>) => Promise<Record<string, string>>;
    getUserCustomProfileAttributesValues: (userID: string) => Promise<Record<string, string>>;
    createPost: (post: PartialExcept<Post, "channel_id" | "message">) => Promise<Post>;
    createPostEphemeral: (userID: string, post: PartialExcept<Post, "channel_id" | "message">) => Promise<Post>;
    updatePost: (post: Post) => Promise<Post>;
    getPost: (postId: string) => Promise<Post>;
    patchPost: (postPatch: PartialExcept<Post, "id">) => Promise<Post>;
    ...
    getUserThreads: (userId: UserProfile["id"] | undefined, teamId: Team["id"], { before, after, perPage, extended, deleted, unread, since, totalsOnly, threadsOnly, }: {
    ...
    createIncomingWebhook: (hook: PartialExcept<IncomingWebhook, "channel_id">) => Promise<IncomingWebhook>;
    ...
    createOAuthApp: (app: PartialExcept<OAuthApp, "name" | "description" | "callback_urls" | "homepage">) => Promise<OAuthApp>;
    ...
    createCustomEmoji: (emoji: PartialExcept<CustomEmoji, "name" | "creator_id">, imageData: File) => Promise<CustomEmoji>;
    ...
    sendTestNotificaiton: () => Promise<StatusOK>;
    ...
    createScheme: (scheme: PartialExcept<Scheme, "display_name" | "scope">) => Promise<Scheme>;
    ...
    getGroupsNotAssociatedToTeam: (teamID: string, q?: string, page?: number, perPage?: number, source?: string, onlySyncableSources?: boolean) => Promise<Group[]>;
    getGroupsNotAssociatedToChannel: (channelID: string, q?: string, page?: number, perPage?: number, filterParentTeamPermitted?: boolean, source?: string, onlySyncableSources?: boolean) => Promise<Group[]>;
    ...
    trackFeatureEvent(featureName: string, event: string, props?: Record<string, unknown>): void;
    ...
    createScheduledPost: (schedulePost: PartialExcept<ScheduledPost, "channel_id" | "message" | "scheduled_at">, connectionId: string) => Promise<ClientResponse<ScheduledPost>>;
    getScheduledPosts: (teamId: string, includeDirectChannels: boolean) => Promise<ClientResponse<{
        [key: string]: ScheduledPost[];
    }>>;
    updateScheduledPost: (schedulePost: ScheduledPost, connectionId: string) => Promise<ClientResponse<ScheduledPost>>;
    deleteScheduledPost: (userId: string, schedulePostId: string, connectionId: string) => Promise<ClientResponse<ScheduledPost>>;
    restorePostVersion: (postId: string, restoreVersionId: string, connectionId: string) => Promise<ClientResponse<Post>>;
}
