...
let BRAND = {
    app: {
        language: 'en',
        name: 'PrivSecure SFU',
        title: 'PrivSecure SFU<br />Free browser based Real-time video calls.<br />Simple, Secure, Fast.',
        description:
    ...
    site: {
        title: 'PrivSecure SFU, Free Video Calls, Messaging and Screen Sharing',
    ...
    meta: {
        description:
            'PrivSecure SFU powered by WebRTC and mediasoup, Real-time Simple Secure Fast video calls, messaging and screen sharing capabilities in the browser.',
        keywords:
    ...
    about: {
        ...
        title: '<strong>WebRTC SFU v1.8.45</strong>',
        html: `
            <button 
                id="support-button" 
            ...
            <a 
                ...
                href="mailto:miroslav.pejic.85@gmail.com?subject=PrivSecure SFU info"> 
                miroslav.pejic.85@gmail.com
            </a>
            <br /><br />
            <hr />
            <span>&copy; 2025 PrivSecure SFU, all rights reserved</span>
            <hr />
        `,
    },
    //...
