...
function leaveFeedback() {
    Swal.fire({
        ...
        text: 'Do you want to rate your PrivSecure experience?',
...
function showAbout() {
    ...
    Swal.fire({
        ...
        title: BRAND.about?.title && BRAND.about.title.trim() !== '' ? BRAND.about.title : 'WebRTC SFU v1.8.45',
        html: `
            <br />
            <div id="about">
                ${
