    ...
    ui: {
        ...
        brand: {
            ...
            app: {
                ...
                name: process.env.APP_NAME || 'Private Video Call System (SFU)',
                title:
                    process.env.APP_TITLE ||
                    '<h1>Private Video Call System (SFU)</h1> Free browser based Real-time video calls.<br />Simple, Secure, Fast.',
                description:
             ...
             */
            site: {
                title: process.env.SITE_TITLE || 'Private Video Call System (SFU), Free Video Calls, Messaging and Screen Sharing',
            ...
            meta: {
                description:
                    ...
                    'Private Video Call System (SFU) powered by WebRTC and mediasoup for real-time video communications.',
            ...
            og: {
                ...
                siteName: process.env.OG_SITE_NAME || 'Private Video Call System (SFU)',
                title: process.env.OG_TITLE || 'Click the link to make a call.',
                description:
                    process.env.OG_DESCRIPTION || 'Private Video Call System (SFU) provides real-time video calls and screen sharing.',
            ...
            about: {
                ...
                html: `
                    ...
                    <a id="email-button" data-umami-event="Email button"
                        href="mailto:${process.env.CONTACT_EMAIL || 'miroslav.pejic.85@gmail.com'}?subject=${process.env.EMAIL_SUBJECT || 'Private Video Call System (SFU) info'}">
                        ${process.env.CONTACT_EMAIL || 'miroslav.pejic.85@gmail.com'}
                    </a>
                    <hr />
                    <span>
                        &copy; ${new Date().getFullYear()} ${process.env.COPYRIGHT_TEXT || 'PrivSecure, all rights reserved'}
                    </span>
                    <hr />
                    `,
            },
