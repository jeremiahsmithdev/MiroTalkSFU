...
class HtmlInjector {
    ...
    getInjectData() {
        return {
            ...
            OG_SITE_NAME: this.config?.og?.siteName || 'Private Video Call System (SFU)',
            OG_TITLE: this.config?.og?.title || 'Click the link to make a call.',
            OG_DESCRIPTION:
                this.config?.og?.description ||
                'Private Video Call System (SFU) calling provides real-time video calls, messaging and screen sharing.',
